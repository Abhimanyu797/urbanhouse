            ...
            <div class="col-md-6 mx-auto">
                <div class="card p-4 shadow">
                    ...
                    <form action="submit-product.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="subCategoryCount" class="form-label">Price of Product</label>
                            <input type="number" class="form-control" id="price" name="price" placeholder="Enter number of subcategories">
                        </div>
